...
// import { Instagram, Facebook, Twitter, Youtube, Link2, Unlink, Loader2 } from "lucide-react";
...
//       });
//       if (res.ok) { toast.success("Disconnected"); fetchConnections(); }
...
//         <p className="text-muted-foreground mt-2 text-lg">Manage your linked social accounts.</p>
//       </header>
...
//                 <div className="p-3 bg-secondary rounded-lg"><Icon className="w-5 h-5" /></div>
//                 <div className="flex-1">
//                   <CardTitle className="text-lg">{platform.name}</CardTitle>
//                   <CardDescription className="text-xs">{connected ? connected.accountName : "Disconnected"}</CardDescription>
//                 </div>
//                 {connected && (
...
//                       <Label htmlFor={`active-${platform.id}`} className="text-sm font-medium cursor-pointer">Sync status</Label>
//                       <Switch id={`active-${platform.id}`} checked={connected.isActive} />
//                     </div>
//                     <Button
//                       variant="ghost"
//                       size="sm"
...
//                   >
//                     {isConnecting ? <Loader2 className="w-4 h-4 animate-spin" /> : <><Link2 className="w-4 h-4 mr-2" />Link {platform.name}</>}
//                   </Button>
//                 )}
//               </CardContent>
//             </Card>
